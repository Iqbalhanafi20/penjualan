...
<title>Master Karyawan | Edit</title>
</head>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Form Edit Karyawan <small>Master</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Form Edit Karyawan</li>
				</ol>
			</section>
            ...
            /edit/proses" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <form:input path="kodeKaryawan" type="text" readonly="true" class="form-control" />
                </div>
                <div class="form-group">
