		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Ubah Data Kota</li>
				</ol>
			</section>
						...
						<div class="box">
							<div class="box-body">
								...
								<form:form method="POST"
									action="${pageContext.request.contextPath}/kota/ubah/proses/${kodeKota}"
									...
									<div class="form-group">
										...
										<form:select path="kodeProvinsi" class="form-control">
											...
											<c:forEach items="${dataProvinsi}" var="p">
												<option
													${p.getKodeProvinsi() == kotaDto.getKodeProvinsi() ? 'selected' : ''}
													value="${p.getKodeProvinsi()}">${p.getNamaProvinsi()}</option>
											</c:forEach>
										</form:select>
									</div>
									<div class="form-group">
