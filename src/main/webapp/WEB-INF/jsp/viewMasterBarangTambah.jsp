...
<title>Master Barang | Tambah</title>
</head>
						...
						<div class="box">
							<div class="box-body">
								...
								<form:form method="POST"
									action="${pageContext.request.contextPath}/barang/tambah/proses"
									...
									<div class="form-group">
										...
										<form:errors path="kodeBarang"></form:errors>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<form:select path="kodeSupplier" class="form-control">
											...
											<c:forEach items="${dataSupplier}" var="p">
												<option value="${p.getKodeSupplier()}">${p.getNamaSupplier()}</option>
											</c:forEach>
										</form:select>
									</div>
									<div class="form-group">
