...
<title>Master Pelanggan | Tambah</title>
</head>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Tambah Data Pelanggan <small>Master Input Form</small>
				</h1>
				<ol class="breadcrumb">
						...
						<div class="box">
							<div class="box-body">
								...
								<form:form method="POST"
									action="${pageContext.request.contextPath}/pelanggan/tambah/proses"
									...
									<div class="form-group">
										...
										<form:select path="kodeKota" class="form-control">
											...
											<c:forEach items="${dataKota}" var="p">
												<option value="${p.getKodeKota()}">${p.getNamaKota()}</option>
											</c:forEach>
										</form:select>
									</div>
									<div class="form-group">
