...
<title>Master Provinsi | Ubah</title>
</head>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Ubah Data Provinsi <small>Master Input Form</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Ubah Data Provinsi</li>
				</ol>
			</section>
						...
						<div class="box">
							<div class="box-body">
								...
								<form:form method="POST"
									action="${pageContext.request.contextPath}/provinsi/ubah/proses/${kodeProvinsi}"
