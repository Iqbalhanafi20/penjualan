	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Form Edit Supplier <small>Master</small>
				</h1>
				<ol class="breadcrumb">
          ...
          <div class="box box-primary">
            ...
            /edit/proses" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="kodesupplier">Kode Supplier</label>
                  <form:input path="kodeSupplier" type="text" class="form-control" readonly="true" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <form:input path="telpSupplier" type="text" class="form-control" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <form:select path="kodeKota" class="form-control">
											...
											<option ${k.getKodeKota() == data.getKodeKota() ? 'selected' : ''} value="${k.getKodeKota()}">${k.getNamaKota()}</option>
											</c:forEach>
										</form:select>
                </div>
              </div>
